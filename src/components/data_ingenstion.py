# code part in Data_ingesntion.py
...
class DataIngestion:
    ...
    def export_data_into_feature_store(self)->DataFrame:
        ...
        try:
            ...
            cardeo_data =cardeovascular_risk_Data()
            dataframe = cardeo_data.export_collection_as_dataframe(collection_name=self.data_ingestion_config.collection_name)
